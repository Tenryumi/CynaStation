...
/proc/readglobal(which)
	switch(which)
		...
		if("civilian_latejoin")
			return global.civilian_latejoin;
		if("prisonwarp")
		...
		if("thaumaturgy_positions")
			return global.thaumaturgy_positions;
		...
		if("poritary_positions")
			return global.poritary_positions;
...
/proc/writeglobal(which, newval)
	switch(which)
		...
		if("civilian_latejoin")
			global.civilian_latejoin=newval;
		if("prisonwarp")
		...
		if("magery_positions")
			global.magery_positions=newval;
		if("stavery_positions")
			global.stavery_positions=newval;
		if("trannelary_positions")
			global.trannelary_positions=newval;
		if("poritary_positions")
			global.poritary_positions=newval;
		if("nonhuman_positions")
